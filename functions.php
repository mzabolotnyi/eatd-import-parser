...
/*
 * —читывает данные из любого excel файла и созадет из них массив.
 * $filename (строка) путь к файлу от корн€ сервера
 */
...
/*
 * —читывает данные из xml файла томов в массив ['id' => 'name']
 */
...
/*
 * —читывает данные из xml файла разработчиков в массив ['id' => 'name']
 */
...
/*
 * —читывает данные из xml файла типов в массив ['id' => 'name']
 */
